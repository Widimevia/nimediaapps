...
@push('scripts')
  ...
  -webkit-filter: blur(2px);
    ...
    <script type="text/x-template" id="selected-cards-template"><date-range
                    ...
                    <button type="button" @click="exportDashboard">Export</button></script>

    <script type="text/x-template" id="cards-collection-template"><draggable v-model="filteredCards" @change="onRowDrop" class="dashboard-content">
    ...
    <script type="text/x-template" id="card-template"><div class="db-wg-spinner" v-if="! dataLoaded">
                ...
                <div v-else :class="`card-data ${className || ''}`">
                    ...
                    <div class="lead" v-else-if="cardType == 'top_card'" v-for="(data, index) in dataCollection.data">
                        ...
                        <div class="details">
                            <span>Rp.@{{ formatPrice(data.amount) }}</span>
                    ...
                    <div id="leads_value" class="column-container" v-else-if="cardType == 'lead_value'" v-for="(data, index) in dataCollection.data">
                        <span style="color:limegreen;">Rp.@{{ formatPrice(data.total) }}</span>
                        <div class="details">
    ...
    <script type="text/x-template" id="card-filter-template"><div class="card-filter-container">
