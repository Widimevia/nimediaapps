...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::prefix(config('app.admin_path'))->group(function () {
        ...
        // register Routes
        Route::get('register', 'Webkul\Admin\Http\Controllers\User\RegisterController@index')->name('admin.register.index');
        
        Route::post('register', 'Webkul\Admin\Http\Controllers\User\RegisterController@create')->name('admin.register.create');
        //login post route to admin auth controller
        Route::post('login', 'Webkul\Admin\Http\Controllers\User\SessionController@store')->name('admin.session.store');

        // Forget Password Routes
        Route::get('forgot-password2', 'Webkul\Admin\Http\Controllers\User\ForgotPasswordController@create')->name('admin.forgot_password.create');
...
// Route::resource('expenses', ExpensesController::class, ['except' => ['create', 'edit']]);
            Route::group([
                ...
                Route::get('', 'ExpensesController@index')->name('admin.expenses.index');

                Route::get('create', 'ExpensesController@create')->name('admin.expenses.create');

                Route::post('create', 'ExpensesController@store')->name('admin.expenses.store');

                Route::get('view/{id?}', 'ExpensesController@view')->name('admin.expenses.view');

                Route::get('edit/{id?}', 'ExpensesController@edit')->name('admin.expenses.edit');
                Route::put('edit/{id}', 'ExpensesController@update')->name('admin.expenses.update');

                Route::get('search', 'ExpensesController@search')->name('admin.expenses.search');

                Route::delete('{id}', 'ExpensesController@destroy')->name('admin.expenses.delete');

                Route::put('mass-update', 'ExpensesController@massUpdate')->name('admin.expenses.mass_update');

                Route::put('mass-destroy', 'ExpensesController@massDestroy')->name('admin.expenses.mass_delete');
            ...
            Route::group([
                ...
                Route::get('create', 'IncomeController@create')->name('admin.income.create');

                Route::post('create', 'IncomeController@store')->name('admin.income.store');

                Route::get('view/{id?}', 'IncomeController@view')->name('admin.income.view');

                Route::get('edit/{id?}', 'IncomeController@edit')->name('admin.income.edit');
                Route::put('edit/{id}', 'IncomeController@update')->name('admin.income.update');

                Route::get('search', 'IncomeController@search')->name('admin.income.search');

                Route::delete('{id}', 'IncomeController@destroy')->name('admin.income.delete');

                Route::put('mass-update', 'IncomeController@massUpdate')->name('admin.income.mass_update');

                Route::put('mass-destroy', 'IncomeController@massDestroy')->name('admin.income.mass_delete');
